...
@end
@implementation CRFLoginFootView
...
//        self.loginBtn.enabled = NO;
        ...
        self.loginBtn.backgroundColor = kRegisterButtonBackgroundColor;
        //(0xEE5250);
        ...
        [self.forgetBtn setTitleColor:kLinkTextColor forState:UIControlStateNormal];
        [self.registerBtn setTitleColor:kLinkTextColor forState:UIControlStateNormal];
