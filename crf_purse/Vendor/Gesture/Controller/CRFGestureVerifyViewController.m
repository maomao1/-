...
@interface CRFGestureVerifyViewController ()<CircleViewDelegate>
...
@implementation CRFGestureVerifyViewController
...
- (void)closeCurrentPage {
    if (self.type == GestureVerifyTypeSettingNew) {
        CRFGestureViewController *gestureVc = [[CRFGestureViewController alloc] init];
