...
@interface CRFGestureViewController ()<UINavigationControllerDelegate, CircleViewDelegate>
...
@implementation CRFGestureViewController
...
- (void)setupDifferentUI
{
    switch (self.type) {
        ...
        case GestureViewControllerTypeRegisterSetting:
...
- (void)circleView:(PCCircleView *)view type:(CircleViewType)type didCompleteSetSecondGesture:(NSString *)gesture result:(BOOL)equal
{
    ...
    if (equal) {
        ...
        //注册成功 回调首页
        [CRFNotificationUtils postNotificationName:kRegisterSuccessNotificationName object:nil];
